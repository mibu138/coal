...
Mat4 m_ScaleUniform_Mat4(const float s, const Mat4 m);
Mat4 m_ScaleNonUniform_Mat4(const Vec3 s, const Mat4 m);
Vec2 m_Translate(const Vec2 t, const Vec2);
void m_Scale(const float scale, Vec2*);
Vec2 m_Add(const Vec2, const Vec2);
